...
export default function AppointmentSteps() {
  return (
    ...
    >
      {/* Detalhe visual de fundo — gradiente CSS, sem blur pesado */}
      <div
        className="absolute inset-0 pointer-events-none"
        aria-hidden="true"
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 90% 10%, rgba(30,52,70,0.25) 0%, transparent 70%), radial-gradient(ellipse 40% 40% at 10% 90%, rgba(200,164,93,0.05) 0%, transparent 70%)",
        }}
      />
